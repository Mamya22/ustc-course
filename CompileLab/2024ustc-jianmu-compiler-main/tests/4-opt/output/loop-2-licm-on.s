...
# br label %label75
	...
	b .main_label75
.main_label6:
# %op68 = phi i32 [ %op66, %label64 ], [ %op76, %label75 ]
# %op69 = phi i32 [ %op71, %label64 ], [ undef, %label75 ]
...
# ret void
	...
	b main_exit
.main_label15:
# %op70 = phi i32 [ %op62, %label20 ], [ %op74, %label72 ]
# %op71 = phi i32 [ %op59, %label20 ], [ %op73, %label72 ]
...
# br label %label6
	...
	b .main_label6
.main_label72:
# %op73 = phi i32 [ %op69, %label11 ]
# %op74 = phi i32 [ 0, %label11 ]
# br label %label15
	ld.w $a0, $fp, -60
	st.w $a0, $fp, -34
	ld.w $a0, $fp, -56
