...
void translate_main(CodeGen *codegen) {
    ...
    // - 数组的大小是多少字节?
    // - 数组的偏移量是多少字节?
    // array一共40字节，%op0挨着array的内存空间，存基址
    offset_map["%op0"] = -64;  // TODO: 请填空
    offset_map["array"] = -20; // TODO: 请填空
    // 计算出基地址
    ...
    codegen->append_inst("st.w", {"$t0", "$fp", std::to_string(offset_map["%op5"])});
